		...
		<div id="<?php $comments->theId(); ?>" class="comment_body contents">
			...
			<section class="commeta">
				<div class="left">
					...
					<time datetime="<?php $comments->date('Y-m-d'); ?>"><?php $comments->date('Y年m月d日'); ?></time>
...
<section id="comments" class="comments">
	...
	<div class="comments-main">
		<h3 id="comments-list-title">评论 | <a ><?php $this->commentsNum(_t('NOTHING'), _t('<span class="noticom">1</span>条评论'), _t('<span class="noticom">%d</span>条评论')); ?></a></h3> 
		...
		<div id="respond_box">
			<div id="<?php $this->respondId(); ?>" class="comment-respond">
				...
				<form action="<?php $this->commentUrl() ?>" method="post" id="commentform">
					...
					<!-- 若当前用户未登录 -->
					<?php else: ?>
					<div class="author-updown">欢迎评论！ &nbsp;<?php $this->remember('author'); ?>&nbsp;<a id="toggle-comment-info">[ 修改 ] ↓</a></div>
					<div id="comment-author-info">
						<input type="text" name="author" id="author" class="commenttext" placeholder="昵称(必须)"  value="<?php $this->remember('author'); ?>" size="22" tabindex="1" placeholder="昵称(必须)" />
						<label for="author"></label>
					
						<input type="text" name="mail" id="mail" class="commenttext" value="<?php $this->remember('mail'); ?>" size="22" placeholder="邮箱(必须)" tabindex="2" />
						<label for="mail"></label>
					
						<input type="text" name="url" id="url" class="commenttext" value="<?php $this->remember('url'); ?>" size="22"placeholder="网站"  tabindex="3" />
						<label for="url"></label>
					</div>
					<div class="clear"></div>
					<?php endif; ?>
					<p><textarea name="text" id="comment" class="OwO-textarea" placeholder="Type in your comments..." tabindex="4" cols="50" rows="5"></textarea></p>
